...
home_implied_prob_col = 'homeTeamImpliedProb'
away_implied_prob_col = 'awayTeamImpliedProb'
home_net_odds_col = 'homeNetOdds'
away_net_odds_col = 'awayNetOdds'
expected_value_col = 'ExpectedValue'
kelly_per_col = 'kellyPer_{size}'
stake_multiplier_col = 'stakeMultiplier'
lineup_strength_col = '{pre}_lineup_strength'
lineup_strength_per60_col = '{pre}_lineup_strength_per60'
